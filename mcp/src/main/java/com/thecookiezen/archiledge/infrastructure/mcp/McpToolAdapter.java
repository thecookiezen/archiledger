...
public class McpToolAdapter {
    ...
    public List<Entity> createEntities(
            @ToolParam(description = "List of entities to create") List<Entity> newEntities) {
    ...
    public List<Relation> createRelations(
            @ToolParam(description = "List of relations to create") List<Relation> newRelations) {
    ...
    public void deleteRelations(
            @ToolParam(description = "List of relations to delete") List<Relation> relationsToDelete) {
    ...
    public Optional<Entity> getEntity(@ToolParam(description = "Name of the entity to retrieve") String name) {
    ...
    public List<Entity> getEntitiesByType(
        ...
        return knowledgeGraphService.getEntitiesByType(new EntityType(entityType));
    }
    ...
    public List<Relation> getRelationsForEntity(
            @ToolParam(description = "Name of the entity to get relations for") String entityName) {
        return knowledgeGraphService.getRelationsForEntity(new EntityId(entityName));
    }
    ...
    public List<Relation> getRelationsByType(
            @ToolParam(description = "The relation type to filter by (e.g., 'DEPENDS_ON', 'USES', 'CONTAINS')") String relationType) {
        return knowledgeGraphService.getRelationsByType(new RelationType(relationType));
    }
    ...
    public List<Entity> getRelatedEntities(
        ...
        return knowledgeGraphService.getRelatedEntities(new EntityId(entityName));
    }
